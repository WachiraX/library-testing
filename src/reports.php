...
// BUG 35: Query doesn't calculate actual fine amount, just shows stored value
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($overdue_result)): 
                                // BUG 36: Fine calculation in display doesn't match stored value
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- BUG 37: Shows calculated fine instead of stored fine -->
