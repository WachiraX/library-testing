...
// BUG 8: Weak session validation - doesn't check session timeout
...
// BUG 9: Incorrect overdue calculation - doesn't consider time
...
<body>
    ...
    <div class="container mt-4">
        ...
        <!-- BUG 10: Overdue counter doesn't auto-update status -->
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        // BUG 11: Missing JOIN optimization, inefficient query
