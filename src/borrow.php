...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$member) {
        ...
        // BUG 20: No check if member is suspended or inactive
        ...
        // BUG 21: Logic error - uses >= instead of >
        if ($current_borrowed >= $member['max_books']) {
            ...
            // BUG 22: Race condition - doesn't lock the record
            if ($book['available_copies'] > 0) {
                // Calculate due date
                // BUG 23: Different member types should have different loan periods
                ...
                // BUG 24: No transaction - can cause inconsistent data
