...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$borrow) {
        ...
        // Calculate fine
        // BUG 25: Incorrect fine calculation - uses simple subtraction instead of date difference
        $fine = 0;
        if ($return_date > $due_date) {
            $days_late = (strtotime($return_date) - strtotime($due_date)) / 86400;
            // BUG 26: Fine rate is hardcoded, should vary by member type
            $fine = $days_late * 5; // 5 Baht per day
            
            // BUG 27: No maximum fine limit
        }
        ...
        // BUG 28: No check if this causes available > total
